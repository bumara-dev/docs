...
| Total NAPSA | Should be roughly 5% of gross, less the ceiling effect |
...
<Steps>
  ...
  <Step title="Bumara calculates and saves">
    ...
    basic, NAPSA at 5% of gross up to the ceiling, and PAYE across the progressive bands. Then
